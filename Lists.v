...
Qed.
*)
Theorem bag_theorem_helper : forall n, 
  count n (add n []) = 1.
Proof.
  intros n.
...
Theorem bag_theorem : forall n s, 
...
Proof.
  intros l1 l2. induction l1 as [|n1 t1 IHl1'].
...
Theorem rev_involutive : forall l : natlist,
  rev (rev l) = l.
Proof.
  intros l. induction l as [|n t IHl'].
  - simpl. reflexivity.
...
Fixpoint eqblist (l1 l2 : natlist) : bool :=
  ...
  | n1 :: t1 => 
    match l2 with
    | nil => false
    | n2 :: t2 => andb (n1 =? n2) (eqblist t1 t2)
    end
  end.
...
Proof.
  intros s. simpl. induction s as [| n t IHs'].
  - simpl. reflexivity.
...
Proof.
  intros l1 l2 IH.
  destruct l1 as [| n1 t1].
  - simpl. rewrite <- rev_involutive. rewrite <- IH. reflexivity.
  - simpl. rewrite <- rev_involutive. rewrite <- IH. rewrite -> rev_involutive. reflexivity.
Qed.
(** [] *)
...
Proof.
  intros d x v.
  simpl. destruct x. simpl. rewrite -> eqb_refl. reflexivity.
Qed.
(** [] *)
...
Proof.
  intros d x y o H.
  simpl.
  destruct x. rewrite -> H. reflexivity.
Qed.
(** [] *)
End PartialMap.
